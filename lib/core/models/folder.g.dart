...
const FolderSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'isExcluded': IndexSchema(
      id: -377814472202002258,
      name: r'isExcluded',
      unique: false,
      replace: false,
      properties: [
...
void _folderSerialize(
  ...
  writer.writeLong(offsets[4], object.trackCount);
}
...
Folder _folderDeserialize(
  ...
  object.id = id;
  object.isExcluded = reader.readBool(offsets[1]);
  object.parentFolderId = reader.readLong(offsets[2]);
  object.path = reader.readString(offsets[3]);
  object.trackCount = reader.readLong(offsets[4]);
  return object;
}
...
extension FolderByIndex on IsarCollection<Folder> {
  Future<Folder?> getByPath(String path) {
    return getByIndex(r'path', [path]);
  }

  Folder? getByPathSync(String path) {
  ...
  Future<List<Folder?>> getAllByPath(List<String> pathValues) {
    final values = pathValues.map((e) => [e]).toList();
    return getAllByIndex(r'path', values);
  }

  List<Folder?> getAllByPathSync(List<String> pathValues) {
    final values = pathValues.map((e) => [e]).toList();
  ...
  Future<Id> putByPath(Folder object) {
    return putByIndex(r'path', object);
  }

  Id putByPathSync(Folder object, {bool saveLinks = true}) {
    return putByIndexSync(r'path', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByPath(List<Folder> objects) {
    return putAllByIndex(r'path', objects);
  }

  List<Id> putAllByPathSync(List<Folder> objects, {bool saveLinks = true}) {
...
extension FolderQueryWhereSort on QueryBuilder<Folder, Folder, QWhere> {
  ...
  QueryBuilder<Folder, Folder, QAfterWhere> anyIsExcluded() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'isExcluded'),
      );
    });
  }
}
...
extension FolderQueryWhere on QueryBuilder<Folder, Folder, QWhereClause> {
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> pathEqualTo(String path) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> pathNotEqualTo(String path) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> isExcludedEqualTo(
      bool isExcluded) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'isExcluded',
        value: [isExcluded],
      ));
    });
  }

  QueryBuilder<Folder, Folder, QAfterWhereClause> isExcludedNotEqualTo(
      bool isExcluded) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension FolderQueryFilter on QueryBuilder<Folder, Folder, QFilterCondition> {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> isExcludedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> trackCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> trackCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> trackCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> trackCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FolderQuerySortBy on QueryBuilder<Folder, Folder, QSortBy> {
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> sortByIsExcluded() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExcluded', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> sortByIsExcludedDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> sortByTrackCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> sortByTrackCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderQuerySortThenBy on QueryBuilder<Folder, Folder, QSortThenBy> {
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> thenByIsExcluded() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExcluded', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> thenByIsExcludedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExcluded', Sort.desc);
    });
  }
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> thenByTrackCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> thenByTrackCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.desc);
    });
  }
...
extension FolderQueryWhereDistinct on QueryBuilder<Folder, Folder, QDistinct> {
  ...
  QueryBuilder<Folder, Folder, QDistinct> distinctByIsExcluded() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QDistinct> distinctByTrackCount() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderQueryProperty on QueryBuilder<Folder, Folder, QQueryProperty> {
  ...
  QueryBuilder<Folder, bool, QQueryOperations> isExcludedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, int, QQueryOperations> trackCountProperty() {
    return QueryBuilder.apply(this, (query) {

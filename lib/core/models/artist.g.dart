...
const ArtistSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'nameKey': IndexSchema(
      id: -8897366021629006998,
      name: r'nameKey',
      unique: true,
      replace: true,
      properties: [
...
void _artistSerialize(
  ...
  writer.writeString(offsets[2], object.nameKey);
  writer.writeLong(offsets[3], object.trackCount);
}
...
Artist _artistDeserialize(
  ...
  final object = Artist();
  object.albumCount = reader.readLong(offsets[0]);
  object.id = id;
  object.name = reader.readString(offsets[1]);
  object.nameKey = reader.readString(offsets[2]);
  object.trackCount = reader.readLong(offsets[3]);
  return object;
}
...
extension ArtistByIndex on IsarCollection<Artist> {
  Future<Artist?> getByNameKey(String nameKey) {
    return getByIndex(r'nameKey', [nameKey]);
  }

  Artist? getByNameKeySync(String nameKey) {
    return getByIndexSync(r'nameKey', [nameKey]);
  }

  Future<bool> deleteByNameKey(String nameKey) {
    return deleteByIndex(r'nameKey', [nameKey]);
  }

  bool deleteByNameKeySync(String nameKey) {
    return deleteByIndexSync(r'nameKey', [nameKey]);
  }

  Future<List<Artist?>> getAllByNameKey(List<String> nameKeyValues) {
    final values = nameKeyValues.map((e) => [e]).toList();
    return getAllByIndex(r'nameKey', values);
  }

  List<Artist?> getAllByNameKeySync(List<String> nameKeyValues) {
    final values = nameKeyValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'nameKey', values);
  }

  Future<int> deleteAllByNameKey(List<String> nameKeyValues) {
    final values = nameKeyValues.map((e) => [e]).toList();
    return deleteAllByIndex(r'nameKey', values);
  }

  int deleteAllByNameKeySync(List<String> nameKeyValues) {
    final values = nameKeyValues.map((e) => [e]).toList();
    return deleteAllByIndexSync(r'nameKey', values);
  }

  Future<Id> putByNameKey(Artist object) {
    return putByIndex(r'nameKey', object);
  }

  Id putByNameKeySync(Artist object, {bool saveLinks = true}) {
    return putByIndexSync(r'nameKey', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByNameKey(List<Artist> objects) {
    return putAllByIndex(r'nameKey', objects);
  }

  List<Id> putAllByNameKeySync(List<Artist> objects, {bool saveLinks = true}) {
    return putAllByIndexSync(r'nameKey', objects, saveLinks: saveLinks);
  }
}
...
extension ArtistQueryWhereSort on QueryBuilder<Artist, Artist, QWhere> {
  ...
  QueryBuilder<Artist, Artist, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension ArtistQueryWhere on QueryBuilder<Artist, Artist, QWhereClause> {
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameKeyEqualTo(
      String nameKey) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameKeyNotEqualTo(
      String nameKey) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<Artist, Artist, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ArtistQueryFilter on QueryBuilder<Artist, Artist, QFilterCondition> {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'nameKey',
        value: '',
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> nameKeyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'nameKey',
        value: '',
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> trackCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> trackCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> trackCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QAfterFilterCondition> trackCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ArtistQuerySortBy on QueryBuilder<Artist, Artist, QSortBy> {
  ...
  QueryBuilder<Artist, Artist, QAfterSortBy> sortByNameKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameKey', Sort.asc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> sortByNameKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameKey', Sort.desc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> sortByTrackCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.asc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> sortByTrackCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ArtistQuerySortThenBy on QueryBuilder<Artist, Artist, QSortThenBy> {
  ...
  QueryBuilder<Artist, Artist, QAfterSortBy> thenByNameKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameKey', Sort.asc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> thenByNameKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nameKey', Sort.desc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> thenByTrackCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.asc);
    });
  }

  QueryBuilder<Artist, Artist, QAfterSortBy> thenByTrackCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'trackCount', Sort.desc);
    });
  }
...
extension ArtistQueryWhereDistinct on QueryBuilder<Artist, Artist, QDistinct> {
  ...
  QueryBuilder<Artist, Artist, QDistinct> distinctByNameKey(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Artist, Artist, QDistinct> distinctByTrackCount() {
    return QueryBuilder.apply(this, (query) {
...
extension ArtistQueryProperty on QueryBuilder<Artist, Artist, QQueryProperty> {
  ...
  QueryBuilder<Artist, String, QQueryOperations> nameKeyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'nameKey');
    });
  }

  QueryBuilder<Artist, int, QQueryOperations> trackCountProperty() {
    return QueryBuilder.apply(this, (query) {
